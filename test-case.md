...
|  # | 条件C1<br>バトルモード 選択済 | 条件C2<br>開始時刻 入力済 | 条件C3<br>開始時刻 妥当 | 条件C4<br>参加上限 2人 | 条件C5<br>備考 文字数 ≤120 | 条件C6<br>ホスト所持エナジー ≥ 必要量 | 実行A1<br>ロビー作成成功 | 実行A2<br>必須項目エラー | 実行A3<br>開始時刻エラー | 実行A4<br>参加上限エラー | 実行A5<br>備考文字数エラー | 実行A6<br>エナジー不足エラー |
|----|:----------------------------:|:-------------------------:|:-----------------------:|:------------------------:|:-------------------------:|:------------------------------------:|:----------------------:|:-----------------:|:-----------------:|:-----------------:|:-------------------:|:--------------------:|
| R1 | Y | Y | Y | Y | Y | Y | ✔ |   |   |   |   |   |
| R2 | N | – | – | – | – | – |   | ✔ |   |   |   |   |
| R3 | Y | N | – | – | – | – |   | ✔ |   |   |   |   |
